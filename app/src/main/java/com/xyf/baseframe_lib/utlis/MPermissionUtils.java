...
public class MPermissionUtils {
    ...
    private static void requestPermissions(Object object, int requestCode, String[] permissions, OnPermissionListener callback) {
        ...
        if (checkPermissions(getContext(object), permissions)) {
            ...
            List<String> deniedPermissions = getDeniendPermissions(getContext(object), permissions);
     ...
     * @return
     */
    private static List<String> getDeniendPermissions(Context context, String[] permissions) {
