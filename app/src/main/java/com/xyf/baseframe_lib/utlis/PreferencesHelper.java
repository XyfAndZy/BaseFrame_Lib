...
//    }
    ...
    public static void saveGuide(int value) {
        sharedPreferences.edit().putInt(guide, value).commit();
    }

    public static int getGuide() {
        return sharedPreferences.getInt(guide, 0);
    }

//    public static void setLogin(boolean value) {
//        sharedPreferences.edit().putBoolean(Constant.IS_LOGIN, value).commit();
//    }
//
