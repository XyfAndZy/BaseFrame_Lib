...
public class BitmapUtils {
    ...
    public static Bitmap genertorNumIcon2(Context context, Bitmap icon,
        ...
        //对bitmap进行滤波处理，当你选择Drawable时，会有抗锯齿的效果
        ...
        if (isShowNum) {
            ...
            float textWidth = numPaint.measureText(num, 0, num.length());
            ...
            //绘制数字
            canvas.drawText(num, iconSize - (backgroundWidth + textWidth) / 2, 22 * factor, numPaint);
        }
        return numIcon;
    }
